inherited EMPLOYEE: TEMPLOYEE
          ...
          inherited GridPanel1: TGridPanel
            ...
            inherited PKDBFindPanel1: TPKDBFindPanel
              ...
              QuerysCollection = <
                item
                  Query = MainQuery
                  QueryCaption = #1057#1086#1090#1088#1091#1076#1085#1080#1082#1080
                  MainQuery = True
                  KeyFieldName = 'ID'
                  FieldList = <
                    item
                    ...
                    item
                      FieldName = 'DEPT'
                      FieldCaption = #1054#1090#1076#1077#1083
                      FieldType = ffString
                      DisplayName = 'DEPT'
                    end
                    item
                    ...
                    item
                      FieldName = 'TABNUMB'
                      FieldCaption = #1058#1072#1073'.'#8470
                      FieldType = ffString
                      DisplayName = 'TABNUMB'
                    end
                    item
                      FieldName = 'FIRSTINDATE'
                      FieldCaption = #1044#1072#1090#1072' '#1087#1086#1089#1090#1091#1087'.'
                      FieldType = ffDate
                      DisplayName = 'FIRSTINDATE'
                    end
                    item
                      FieldName = 'INDATE'
                      FieldCaption = #1044#1072#1090#1072' '#1085#1072#1079#1085#1072#1095'.'
                    ...
                    item
                      FieldName = 'PASSPORTNUMB'
                      FieldCaption = #8470' '#1087#1072#1089#1087#1086#1088#1090#1072
                      FieldType = ffString
                      DisplayName = 'PASSPORTNUMB'
                    end
                    item
                      FieldName = 'PASSINST'
                      FieldCaption = #1055#1072#1089#1087'. '#1086#1088#1075'-'#1080#1103'.'
                      FieldType = ffString
                      DisplayName = 'PASSINST'
                    end
                    item
                      FieldName = 'BIRTHDATE'
                      FieldCaption = #1044#1072#1090#1072' '#1088#1086#1078'.'
                      FieldType = ffDate
                      DisplayName = 'BIRTHDATE'
                    end
                    item
  ...
  inherited MainQuery: TADQuery
    Connection = DataModule1.ADConnection1
    SQL.Strings = (
      'select * from hr_v_empcitezen t'
      'where '
      '(t.statusid <> 1806639)       -- '#1090#1086#1083#1100#1082#1086' '#1072#1082#1090#1080#1074#1085#1099#1077
      'and (t.workunittype=3009016)  -- '#1090#1086#1083#1100#1082#1086' '#1086#1089#1085#1086#1074#1085#1072#1103' '#1088#1072#1073#1086#1090#1072)
    Top = 0
    ...
    object MainQueryFIRSTINDATE: TDateTimeField
      DisplayLabel = #1044#1072#1090#1072' '#1087#1086#1089#1090#1091#1087'.'
      FieldName = 'FIRSTINDATE'
    end
    ...
    object MainQueryPASSINST: TStringField
      DisplayLabel = #1055#1072#1089#1087'. '#1086#1088#1075'-'#1080#1103'.'
      FieldName = 'PASSINST'
      Size = 200
    end
  ...
  object ADQuery8: TADQuery
    ...
    object ADQuery8ROWCONTENT: TStringField
  ...
  object ADQuery10: TADQuery
    ...
    SQL.Strings = (
      'select '
      't.citezenid id, t.structureid structureid '
      'from '
      'hr_v_empcitezen t'
      'where t.id=:ID')
    Left = 352
