...
begin
  ...
  if ADQuery1DAYTYPE.AsString ='œÕ' then
  begin
  h := 6;
  n := 4;
  k := 8;
  ...
  if ADQuery1DAYTYPE.AsString ='œ“' then
  begin
  h := 4;
  n := 312;
  k := 4;
...
procedure TWORKCALENDAR.Button1Click(Sender: TObject); {”“¬≈–ƒ»“‹ »«Ã≈Õ≈Õ»ﬂ}
var
i,j,p:integer;
...
procedure  TWORKCALENDAR.ComboBox1Change(Sender: TObject); {Œ¡ÕŒ¬À≈Õ»ﬂ › –¿Õ¿}
var
i:integer;
begin
...
begin
     decodedate(now,year,mon,day);
      ...
      case mon of
      01: ComboBox1.Text:='ˇÌ‚‡¸';
      02: ComboBox1.Text:='ÙÂ‚‡Î¸';
      03: ComboBox1.Text:='Ï‡Ú';
      04: ComboBox1.Text:='‡ÔÂÎ¸';
      05: ComboBox1.Text:='Ï‡È';
      06: ComboBox1.Text:='Ë˛Ì¸';
      07: ComboBox1.Text:='Ë˛Î¸';
      08: ComboBox1.Text:='‡‚„ÛÒÚ';
      09: ComboBox1.Text:='ÒÂÌÚˇ·¸';
      10: ComboBox1.Text:='ÓÍÚˇ·¸';
      11: ComboBox1.Text:='ÌÓˇ·¸';
      12: ComboBox1.Text:='‰ÂÍ‡·¸';
      end;
