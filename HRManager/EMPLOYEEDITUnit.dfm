inherited EMPLOYEEDIT: TEMPLOYEEDIT
  ...
  object ADQuery3: TADQuery
    ...
    SQL.Strings = (
      'SELECT '
      '        ee.structureid , st.description'
      'FROM '
      '        HR_EMPLOYEE ee '
      #9',CS_SCHEDULE_STRUCTURE st'
      'WHERE '
      '        ee.citezenid= :xcitezenid'
      #9'AND ee.structureid=st.id'
      
        '        AND ((ee.workunittype = 6275939) OR (ee.workunittype = 6' +
        '275940))'
      '        AND ee.status=1806638'
      ''
      '-- '#1076#1083#1103' '#1089#1086#1090#1088' '#1088#1072#1073#1086#1090#1072#1074#1096#1080#1093' '#1087#1086' '#1076#1086#1075#1086#1074#1086#1088#1091' '#1087#1086#1076#1090#1103#1075#1080#1074#1072#1077#1084' '#1089#1090#1072#1088#1091#1102' '#1076#1086#1083#1078#1085#1086#1089#1090#1100)
    Left = 440
    Top = 184
    ParamData = <
      item
    ...
    object ADQuery3STRUCTUREID: TFMTBCDField
      FieldName = 'STRUCTUREID'
      Precision = 38
      Size = 38
    end
    object ADQuery3DESCRIPTION: TStringField
