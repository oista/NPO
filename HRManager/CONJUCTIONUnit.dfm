inherited CONJUCTION: TCONJUCTION
          ...
          object TabSheet14: TTabSheet
            ...
            object GridPanel12: TGridPanel
              ...
              object PKDBEditButtons12: TPKDBEditButtons
                ...
                Width = 150
                Height = 28
                TableName = 'HR_REGISTRATION'
                PrimaryFieldName = 'ID'
                Grid = VrDbGrid11
                Connection = DataModule1.ADConnection1
                UseTempTable = False
                EditDialogClassName = 'TREGISTRATIONEDIT'
                DesignSize = (
                  150
                  28)
              end
              ...
              QuerysCollection = <
                item
                  ...
                  FieldList = <
                    ...
                    item
                      FieldName = 'AGREEMENTNUMB'
                      FieldCaption = #8470' '#1058#1088#1091#1076#1086#1074#1086#1075#1086' '#1076#1086#1075#1086#1074#1086#1088#1072
                      FieldType = ffString
                      DisplayName = 'AGREEMENTNUMB'
                    end
                    item
                      FieldName = 'AGREEMENTDATE'
                      FieldCaption = #1044#1072#1090#1072' '#1090#1088#1091#1076#1086#1074#1086#1075#1086' '#1076#1086#1075#1086#1074#1086#1088#1072
                      FieldType = ffDate
                      DisplayName = 'AGREEMENTDATE'
                    end
                    item
  ...
  object ADQuery11: TADQuery
    ...
    Connection = DataModule1.ADConnection1
    SQL.Strings = (
      'select * from HR_V_REGISTRATION t'
      'where t.citezenid=:ID')
    Left = 384
    Top = 208
    ParamData = <
    ...
    object ADQuery6ADRESS: TStringField
      FieldName = 'ADRESS'
      Size = 200
    end
    ...
    object ADQuery6PHONEID: TFMTBCDField
      FieldName = 'PHONEID'
    end
  end
  ...
  object ADQuery10: TADQuery
    ...
    SQL.Strings = (
        ...
        'select t.citezenid id, t.structureid structureid from hr_v_empci' +
        'tezen t'
      'where t.id=:ID')
    Left = 352
    Top = 168
