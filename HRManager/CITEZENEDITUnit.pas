...
fio_type:string; out_label:TPKDBLabelEdit);
 begin
  ADStoredProc1.Params[1].Value:= fio_string;
  ADStoredProc1.Params[2].Value:= case_type;
  ADStoredProc1.Params[3].Value:= fio_type;
  ADStoredProc1.ExecProc;
  out_label.Text:= ADStoredProc1.Params[0].Value;
end;
