...
begin
  ...
  if Form.ModalResult = mrOK then
     begin
       ...
       ADStoredProc2.Params[0].Value := MainQueryID.Asstring;
      // дата перехода в архив.  вытягивать при необходимости из бд
      // ADStoredProc2.Params[1].Value := '00.00.0000';
...
procedure TCONTWORKER.PKDBEditButtons1BeforeOpenEditClick(Sender: TObject;
  Form: TEMPLOYEEDIT);
begin      // значения по умолчанию для договорняков
...
begin
  inherited;
  // значения по умолчанию для договорняков
