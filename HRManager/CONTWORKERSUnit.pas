...
// переход на другую запись
procedure TEMPLOYEE.GridCellClick(Column: TColumn);
begin
  inherited;
  anotherrow;
end;
// переход на другую запись
procedure TEMPLOYEE.GridKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
  anotherrow;
...
// переход на другую запись
procedure TEMPLOYEE.GridKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
  anotherrow;
